...
hero:
  ...
  tagline: "まずクイックスタート。その後に設定パターン、ランタイム、Go 組み込みを読む。"
  actions:
    - theme: brand
      text: クイックスタート
  ...
  <div class="morph-home-start-grid">
    <article class="morph-home-route">
      <div class="morph-home-route-head">
        ...
        <p class="morph-home-route-copy">まず CLI を導入し、ワークスペースを初期化し、モデル鍵・環境変数・既定値を固めてから他の runtime や embedding ガイドへ進む。</p>
      </div>
