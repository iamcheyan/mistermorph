...
// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.core/architectureDiagram-2XIMDMQ5.mjs
...
function getAlignments(db, spatialMaps, groupAlignments) {
  ...
  const alignments = spatialMaps.map((spatialMap) => {
    ...
    Object.entries(spatialMap).forEach(([id, [x, y]]) => {
      ...
      (_a2 = horizontalAlignments[y])[nodeGroup] ?? (_a2[nodeGroup] = []);
      horizontalAlignments[y][nodeGroup].push(id);
      verticalAlignments[x] ?? (verticalAlignments[x] = {});
      (_b = verticalAlignments[x])[nodeGroup] ?? (_b[nodeGroup] = []);
